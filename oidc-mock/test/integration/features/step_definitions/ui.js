...
const hostAlias = process.env.RUNTIME_HOST_ALIAS
...
Given('I navigate to the authorize page', async function() {
  ...
  return await this.page.goto('https://' + hostAlias + 
    '/v1/openid-connect/authorize?client_id=' + this.apickli.scenarioVariables.clientId
